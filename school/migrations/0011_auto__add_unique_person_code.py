...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Person', fields ['code']
        db.create_unique('school_person', ['code'])


    def backwards(self, orm):
        # Removing unique constraint on 'Person', fields ['code']
        db.delete_unique('school_person', ['code'])
