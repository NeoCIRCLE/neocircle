...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Person.code'
        db.add_column('school_person', 'code',
                      self.gf('django.db.models.fields.CharField')(default='MIGRATEME', max_length=30),
                      keep_default=False)


        # Changing field 'Person.user'
        db.alter_column('school_person', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], unique=True, null=True))

    def backwards(self, orm):
        # Deleting field 'Person.code'
        db.delete_column('school_person', 'code')
