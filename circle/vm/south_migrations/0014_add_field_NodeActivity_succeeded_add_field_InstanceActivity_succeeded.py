...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NodeActivity.succeeded'
        db.add_column(u'vm_nodeactivity', 'succeeded',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'InstanceActivity.succeeded'
        db.add_column(u'vm_instanceactivity', 'succeeded',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NodeActivity.succeeded'
        db.delete_column(u'vm_nodeactivity', 'succeeded')

        # Deleting field 'InstanceActivity.succeeded'
        db.delete_column(u'vm_instanceactivity', 'succeeded')
