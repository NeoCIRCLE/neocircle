...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InstanceActivity.resultant_state'
        db.add_column(u'vm_instanceactivity', 'resultant_state',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InstanceActivity.resultant_state'
        db.delete_column(u'vm_instanceactivity', 'resultant_state')
