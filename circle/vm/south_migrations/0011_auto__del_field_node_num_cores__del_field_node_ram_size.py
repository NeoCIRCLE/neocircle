...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Node.num_cores'
        db.delete_column(u'vm_node', 'num_cores')

        # Deleting field 'Node.ram_size'
        db.delete_column(u'vm_node', 'ram_size')


    def backwards(self, orm):
        # Adding field 'Node.num_cores'
        db.add_column(u'vm_node', 'num_cores',
                      self.gf('django.db.models.fields.IntegerField')(default=1024),
                      keep_default=False)

        # Adding field 'Node.ram_size'
        db.add_column(u'vm_node', 'ram_size',
    ...
    models = {
        ...
        u'vm.instanceactivity': {
            'Meta': {'ordering': "['-started', 'instance', '-id']", 'object_name': 'InstanceActivity'},
