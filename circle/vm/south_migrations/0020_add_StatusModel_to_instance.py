...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'vm_instance', 'status',
                      self.gf('model_utils.fields.StatusField')(default=u'NOSTATE', max_length=100, no_check_for_status=True),
                      keep_default=False)

        # Adding field 'Instance.status_changed'
        db.add_column(u'vm_instance', 'status_changed',
                      self.gf('model_utils.fields.MonitorField')(default=datetime.datetime.now, monitor=u'status'),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Instance.status'
        db.delete_column(u'vm_instance', 'status')

        # Deleting field 'Instance.status_changed'
        db.delete_column(u'vm_instance', 'status_changed')
