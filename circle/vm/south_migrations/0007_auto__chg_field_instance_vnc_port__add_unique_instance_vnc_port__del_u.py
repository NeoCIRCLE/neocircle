...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Instance', fields ['node', 'vnc_port']
        db.delete_unique(u'vm_instance', ['node_id', 'vnc_port'])


        # Changing field 'Instance.vnc_port'
        db.alter_column(u'vm_instance', 'vnc_port', self.gf('django.db.models.fields.IntegerField')(unique=True, null=True))
        # Adding unique constraint on 'Instance', fields ['vnc_port']
        db.create_unique(u'vm_instance', ['vnc_port'])


    def backwards(self, orm):
        # Removing unique constraint on 'Instance', fields ['vnc_port']
        db.delete_unique(u'vm_instance', ['vnc_port'])


        # Changing field 'Instance.vnc_port'
        db.alter_column(u'vm_instance', 'vnc_port', self.gf('django.db.models.fields.IntegerField')())
        # Adding unique constraint on 'Instance', fields ['node', 'vnc_port']
        db.create_unique(u'vm_instance', ['node_id', 'vnc_port'])
