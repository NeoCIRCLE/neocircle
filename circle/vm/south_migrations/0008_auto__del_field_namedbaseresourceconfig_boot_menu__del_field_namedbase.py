...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'NamedBaseResourceConfig.boot_menu'
        db.delete_column(u'vm_namedbaseresourceconfig', 'boot_menu')

        # Deleting field 'NamedBaseResourceConfig.raw_data'
        db.delete_column(u'vm_namedbaseresourceconfig', 'raw_data')


    def backwards(self, orm):
        # Adding field 'NamedBaseResourceConfig.boot_menu'
        db.add_column(u'vm_namedbaseresourceconfig', 'boot_menu',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'NamedBaseResourceConfig.raw_data'
        db.add_column(u'vm_namedbaseresourceconfig', 'raw_data',
