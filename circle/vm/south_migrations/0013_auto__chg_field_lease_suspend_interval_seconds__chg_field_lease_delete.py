...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Lease.suspend_interval_seconds'
        db.alter_column(u'vm_lease', 'suspend_interval_seconds', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Lease.delete_interval_seconds'
        db.alter_column(u'vm_lease', 'delete_interval_seconds', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Lease.suspend_interval_seconds'
        db.alter_column(u'vm_lease', 'suspend_interval_seconds', self.gf('django.db.models.fields.IntegerField')(default=0))

        # Changing field 'Lease.delete_interval_seconds'
        db.alter_column(u'vm_lease', 'delete_interval_seconds', self.gf('django.db.models.fields.IntegerField')(default=0))
    ...
    models = {
        ...
        u'vm.instanceactivity': {
            'Meta': {'ordering': "[u'-started', u'instance', u'-id']", 'object_name': 'InstanceActivity'},
        ...
        u'vm.lease': {
            ...
            'delete_interval_seconds': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '100'}),
            'suspend_interval_seconds': ('django.db.models.fields.IntegerField', [], {'null': 'True'})
        },
