...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Node.normalized_name'
        db.add_column(u'vm_node', 'normalized_name',
                      self.gf('common.models.HumanSortField')(default='', maximum_number_length=4, max_length=100, monitor=u'name'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Node.normalized_name'
        db.delete_column(u'vm_node', 'normalized_name')
    ...
    models = {
        ...
        u'vm.node': {
            ...
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '50'}),
            'normalized_name': ('common.models.HumanSortField', [], {'default': "''", 'maximum_number_length': '4', 'max_length': '100', 'monitor': "u'name'"}),
