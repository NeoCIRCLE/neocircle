...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Trait'
        db.create_table(u'vm_trait', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal(u'vm', ['Trait'])

        # Adding M2M table for field req_traits on 'Instance'
        m2m_table_name = db.shorten_name(u'vm_instance_req_traits')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('instance', models.ForeignKey(orm[u'vm.instance'], null=False)),
            ('trait', models.ForeignKey(orm[u'vm.trait'], null=False))
        ))
        db.create_unique(m2m_table_name, ['instance_id', 'trait_id'])

        # Adding M2M table for field req_traits on 'InstanceTemplate'
        m2m_table_name = db.shorten_name(u'vm_instancetemplate_req_traits')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('instancetemplate', models.ForeignKey(orm[u'vm.instancetemplate'], null=False)),
            ('trait', models.ForeignKey(orm[u'vm.trait'], null=False))
        ))
        db.create_unique(m2m_table_name, ['instancetemplate_id', 'trait_id'])

        # Adding M2M table for field traits on 'Node'
        m2m_table_name = db.shorten_name(u'vm_node_traits')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('node', models.ForeignKey(orm[u'vm.node'], null=False)),
            ('trait', models.ForeignKey(orm[u'vm.trait'], null=False))
        ))
        db.create_unique(m2m_table_name, ['node_id', 'trait_id'])


    def backwards(self, orm):
        # Deleting model 'Trait'
        db.delete_table(u'vm_trait')

        # Removing M2M table for field req_traits on 'Instance'
        db.delete_table(db.shorten_name(u'vm_instance_req_traits'))

        # Removing M2M table for field req_traits on 'InstanceTemplate'
        db.delete_table(db.shorten_name(u'vm_instancetemplate_req_traits'))

        # Removing M2M table for field traits on 'Node'
        db.delete_table(db.shorten_name(u'vm_node_traits'))
