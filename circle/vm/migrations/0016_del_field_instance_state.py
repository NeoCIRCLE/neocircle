...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Instance.state'
        db.delete_column(u'vm_instance', 'state')

    def backwards(self, orm):
        # Adding field 'Instance.state'
        db.add_column(u'vm_instance', 'state',
                      self.gf('django.db.models.fields.CharField')(default='NOSTATE', null=True, max_length=50, blank=True),
                      keep_default=False)
