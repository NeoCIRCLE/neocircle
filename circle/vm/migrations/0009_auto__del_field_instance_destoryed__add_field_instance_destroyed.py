...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Instance.destoryed'
        db.delete_column(u'vm_instance', 'destoryed')

        # Adding field 'Instance.destroyed'
        db.add_column(u'vm_instance', 'destroyed',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Instance.destoryed'
        db.add_column(u'vm_instance', 'destoryed',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Instance.destroyed'
        db.delete_column(u'vm_instance', 'destroyed')
