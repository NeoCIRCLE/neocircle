...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.use_gravatar'
        db.add_column(u'dashboard_profile', 'use_gravatar',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.use_gravatar'
        db.delete_column(u'dashboard_profile', 'use_gravatar')
