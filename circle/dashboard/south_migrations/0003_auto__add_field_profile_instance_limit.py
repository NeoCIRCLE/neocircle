...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.instance_limit'
        db.add_column(u'dashboard_profile', 'instance_limit',
                      self.gf('django.db.models.fields.IntegerField')(default=5),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.instance_limit'
        db.delete_column(u'dashboard_profile', 'instance_limit')
