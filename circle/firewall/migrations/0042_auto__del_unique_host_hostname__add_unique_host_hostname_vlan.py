...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'firewall_host', ['hostname'])

        # Adding unique constraint on 'Host', fields ['hostname', 'vlan']
        db.create_unique(u'firewall_host', ['hostname', 'vlan_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Host', fields ['hostname', 'vlan']
        db.delete_unique(u'firewall_host', ['hostname', 'vlan_id'])

        # Adding unique constraint on 'Host', fields ['hostname']
        db.create_unique(u'firewall_host', ['hostname'])
