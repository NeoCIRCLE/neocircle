...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SwitchPort.tagged_vlans'
        db.alter_column(u'firewall_switchport', 'tagged_vlans_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['firewall.VlanGroup']))

    def backwards(self, orm):

        # Changing field 'SwitchPort.tagged_vlans'
        db.alter_column(u'firewall_switchport', 'tagged_vlans_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['firewall.VlanGroup']))
