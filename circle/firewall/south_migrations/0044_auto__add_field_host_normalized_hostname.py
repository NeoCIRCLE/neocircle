...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Host.normalized_hostname'
        db.add_column(u'firewall_host', 'normalized_hostname',
                      self.gf('common.models.HumanSortField')(default='', maximum_number_length=4, max_length=80, monitor='hostname'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Host.normalized_hostname'
        db.delete_column(u'firewall_host', 'normalized_hostname')
    ...
    models = {
        ...
        u'firewall.host': {
            ...
            'modified_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'normalized_hostname': ('common.models.HumanSortField', [], {'default': "''", 'maximum_number_length': '4', 'max_length': '80', 'monitor': "'hostname'"}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
