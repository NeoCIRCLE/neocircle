...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Vlan.ipv6_template'
        db.add_column(u'firewall_vlan', 'ipv6_template',
                      self.gf('django.db.models.fields.TextField')(default='2001:738:2001:4031:%(b)d:%(c)d:%(d)d:0'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Vlan.ipv6_template'
        db.delete_column(u'firewall_vlan', 'ipv6_template')
