...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DiskActivity.succeeded'
        db.add_column(u'storage_diskactivity', 'succeeded',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DiskActivity.succeeded'
        db.delete_column(u'storage_diskactivity', 'succeeded')
