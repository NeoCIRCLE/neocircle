...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Share', fields ['name']
        db.delete_unique('one_share', ['name'])


    def backwards(self, orm):
        # Adding unique constraint on 'Share', fields ['name']
        db.create_unique('one_share', ['name'])
