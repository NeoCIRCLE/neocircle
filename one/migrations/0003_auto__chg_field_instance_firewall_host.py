...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Instance.firewall_host'
        db.alter_column('one_instance', 'firewall_host_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['firewall.Host'], null=True))

    def backwards(self, orm):

        # Changing field 'Instance.firewall_host'
        db.alter_column('one_instance', 'firewall_host_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['firewall.Host']))
