...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Instance.firewall_host'
        db.add_column('one_instance', 'firewall_host',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['firewall.Host']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Instance.firewall_host'
        db.delete_column('one_instance', 'firewall_host_id')
    ...
    models = {
        ...
        'one.instance': {
            ...
            'firewall_host': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['firewall.Host']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
